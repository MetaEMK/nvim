return {
    ...
    config = function()
        ...
        vim.keymap.set("n", "<A-a>", function() harpoon:list():select(5) end)
        vim.keymap.set("n", "<A-s>", function() harpoon:list():select(6) end)
        vim.keymap.set("n", "<A-d>", function() harpoon:list():select(7) end)
        vim.keymap.set("n", "<A-f>", function() harpoon:list():select(8) end)
